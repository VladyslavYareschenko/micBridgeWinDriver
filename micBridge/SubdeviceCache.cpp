...
{
	PAGED_CODE();
	DPF_ENTER(("[AdapterCommon::CacheSubdevice]"));
...
NTSTATUS __stdcall SubdeviceCache::Remove(_In_ PWSTR Name)
{
	PAGED_CODE();
	DPF_ENTER(("[AdapterCommon::RemoveCachedSubdevice]"));
...
{
	PAGED_CODE();
	DPF_ENTER(("[AdapterCommon::EmptySubdeviceCache]"));
